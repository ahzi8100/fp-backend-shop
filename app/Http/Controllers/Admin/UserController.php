...
class UserController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        confirmDelete('Detele User!', 'Are you sure want to delete it?');
    ...
    public function update(Request $request, User $user)
    {
        ...
        if (!$user) {
            Alert::error('Update Failed', 'Data Gagal Diperbarui!');
            return redirect()->route('admin.user.index');
        }

        Alert::success('Update Successfully', 'Data Berhasil Diperbarui!');
        return redirect()->route('admin.user.index');
    }
