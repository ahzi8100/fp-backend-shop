...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <div class="card border-0 shadow mb-4">
                    ...
                    <!-- Card Body -->
                    <div class="card-body">
                        <h5>{{ Number::currency($revenueMonth, in: 'IDR', locale: 'id') }}</h5>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card border-0 shadow mb-4">
                    ...
                    <!-- Card Body -->
                    <div class="card-body">
                        <h5>{{ Number::currency($revenueYear, in: 'IDR', locale: 'id') }}</h5>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card border-0 shadow mb-4">
                    ...
                    <!-- Card Body -->
                    <div class="card-body">
                        <h5>{{ Number::currency($revenueAll, in: 'IDR', locale: 'id') }}</h5>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <!-- Earnings (Monthly) Card Example copas dari template index.html -->
